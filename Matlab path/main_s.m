...
%         rob0.utc_startup = 143225.5;
        rob0.utc_startup = 143225;
%         rob0.utc_end = 143355;
%         rob0.utc_end = 143405; % -0.6
        rob0.utc_end = 143340; % -0.6

        rob0.utc_yawtime = rob0.utc_startup + 0.1;
%         rob0.utc_offset = -0.78;
%         rob0.utc_offset = -1.00;
%         rob0.utc_offset = -1.1;
%         rob0.utc_offset = -0.1;
        rob0.utc_offset = -0.6;
%         rob0.utc_offset = -0.5;
...
for xx = 1:i_rob
    rob(xx).utc = rob(1).utc + rob0.utc_offset_odom;
end
...
% % % % % %     abschtime(robot_i,1:a) = double(GPS(1,1:a,4)) - double(xyth(robot_i,1:a,4)) - 3*rob0.utc_offset ;
...
% % % % %     xx = 10
% % % % % %     casova_osa = xyth(robot_i,1:xx:end ,4) - rob0.utc_startup - 1;
% % % % %     casova_osa = xyth(robot_i,1:xx:end,4) - rob0.utc_startup;
% % % % %     title( strcat( ...
